...
//P: I need a counter to count the steps, while looop that loops to number to string .length > 2, copy of the number and assign to string, create x and y variables that correspond to digits up until last and last digit, count++
